        ...
        <header class="header">
            ...
            <div class="navbar">
                <div class="navbar-left-container">
                    <a href="/">
                        <img class="navbar-brand-logo" :src="require('../../static/logo.png')">
                    </a>
                </div>
                <div class="search-btn">
                    <div class="el-autocomplete" minlength="1" maxlength="100">
                        <div class="el-input"><!---->
                            ...
                            <input placeholder="请输入商品信息" icon="search" type="text" rows="2" class="el-input__inner"
                                   v-model="secContent">
                        </div>
                    </div>
                </div>
                <div class="navbar-right-container" style="display: flex;">
                    <div class="navbar-menu-container">
                                ...
                                <div class="nav-info-list">
                                    <ul>
                                        ...
                                        <li class="user-li-style">
                                            <router-link to="/index/orderlist">我的订单</router-link>
                                        </li>
                                        <li class="user-li-style">
                                            <router-link to="/user/information">账号资料</router-link>
                                        </li>
                                        <li class="user-li-style">
                                            <router-link to="/index/addresslist">收货地址</router-link>
                                        </li>
                                        <!-- <li class="user-li-style">
                        ...
                        <div class="navbar-cart-container" v-on:mouseover="cartShow" v-on:mouseout="cartHidden">
                            <router-link to='/index/cart' class="navbar-link navbar-cart-link">
                                ...
                                <div class="nav-user-list">
                                    <div class="full" v-show="haveLen">
                                        ...
                                        <div class="nav-cart-items">
                                            <ul>
                                                <li class="clearfix" v-for="(item,index) in cartList" :key="index"
                                                    v-on:mouseover="delShowIndex=index">
                                                    <div class="cart-item">
                                                        <div class="cart-item-inner">
                                                            <a @click="goDetail(item)">
                                                                <div class="item-thumb">
                                                                    <img v-lazy="require(`../../static/${item.productimg}`)">
                                                                </div>
                                                                <div class="item-desc">
                                                                    <div class="cart-cell">
                                                                        <h4>
                                                            ...
                                                            <div class="del-btn del" @click="delCartList(item)"
                                                                 :class="{'showDel':delShowIndex==index?true:false}">删除
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="nav-cart-total">
                                            ...
                                            <h5>合计：<span class="price-icon">¥</span><span class="price-num">{{totalPrice}}</span>
                                            </h5>
                                            <h6>
                                                <router-link to='/index/cart'>
                                                    <input type="button" readonly="readonly" class="main-btn"
                                                           value="去购物车"
                    ...
                    <div class="md-content">
                        <div class="confirm-tips">
                            <div class="error-wrap">
                                <span class="error error-show" v-if="errTip">用户名或者密码错误</span>
                                <span class="error error-show" v-if="errTip1">用户名不存在</span>
                                <span class="error error-show" v-if="errTip2">用户名或密码不能为空</span>
                            ...
                            <ul>
                                <li class="regi_form_input">
                                    ...
                                    <input type="text" tabindex="1" name="loginname" v-model="userName"
                                           class="regi_login_input regi_login_input_left" placeholder="用户账号"
                                           data-type="loginname" @blur="login">
                                </li>
                                <li class="regi_form_input noMargin">
                                    ...
                                    <input type="password" tabindex="2" name="password" v-model="userPwd"
                                           ...
                                           placeholder="密码" @keyup.enter="login" @blur="login">
                                </li>
                                <li class="check-btn">
            ...
            <register :registShow="registShow" v-on:close="registShow = false"
                      v-on:showlogin="registShow=false,loginShow=true"></register>
        </header>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            logout() { // 注销
                API.logout().then((res) => {
                    if (res.status == '1') {
                     ...
                     /*   this.$store.commit('updateCartList', {});*//*退出不更新购物车数据*/
                        this.$store.commit('updateHaveProduct', false);
                        this.ifLogin = false;
                        this.$router.push({
                            path: '/index'
            ...
            getCartData() {
                API.getCartData().then((res) => {
                    if (res.code == '0') {
                        this.$store.commit('initCartCount', res.data.length);
                        this.$store.commit('initCartList', res.data);
