        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li v-for="item in limitAdressNum" :class="{'check':item.isdefault===1}" :key="item.addressId">
                    <dl>
                      <dt>{{item.username}}</dt>
...
import insertAdr from '@/components/shop/insertAdr'
      ...
      methods:{
        ...
        insertAdr(item) {
          ...
          // console.log(this.newAddressList.userName);
            console.log("BBBBBBBBB"+JSON.parse(localStorage.getItem('user')));
          var param = {
        ...
        setDefault(item) {
          ...
          API.setDefauleAdr(param).then( (res) => {
            res = res.data;
            if(res.status === '1') {
              // console.log('设置成功');
            }
