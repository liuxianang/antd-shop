    ...
    <div>
      ...
      <div class="container">
        ...
        <div class="order-create">
          <div class="order-create-pic"><img :src="require('../../static/ok-2.png')" alt=""></div>
          <div class="order-create-main">
            ...
            <div class="order-create-btn-wrap">
              <div class="btn-l-wrap">
                <router-link to="/index/orderlist" class="btn btn--m">全部订单</router-link>
              </div>
              <div class="btn-r-wrap">
                <router-link to="/index" class="btn btn--m">继续购物</router-link>
              </div>
            </div>
          </div>
        </div>
